...
<div class="header bg-main">
    ...
    <div class="head-l">${academy.acaName}${grade.graName}&nbsp;${teacher.teaName}
        老师
        <a class="button button-little bg-red" href="/logout"><span class="icon-power-off"></span> 退出登录</a> </div>
    <div class="logo margin-big-left fadein-top">
        <h1><img src="../../../img/avator/${teacher.avator}" class="radius-circle rotate-hover" height="50" alt="" /></h1>
    </div>
</div>
<div class="leftnav">
    <div class="leftnav-title"><strong><span class="icon-list"></span>菜单列表</strong></div>
        ...
        <ul style="display:block" id = "ul1">
            <li><a href="/teacher/infoUi" target="right"><span class="icon-caret-right"></span>个人信息</a></li>
            <li><a href="/teacher/passUi" target="right"><span class="icon-caret-right"></span>密码管理</a></li>
        </ul>
        <h2><span class="icon-pencil-square-o"></span>功能设置</h2>
        <ul id="ul2">
            <li><a href="/teacher/classMan" target="right"><span class="icon-caret-right"></span>班级管理</a></li>
            <li><a href="/sec/gra?id=${user.userNumber}" target="right"><span class="icon-caret-right"></span>课表管理</a></li>
